...
type IconName =
  | "inbox" | "mail" | "mail-in" | "mail-out"
  | "ship" | "truck" | "plane" | "box"
  | "file" | "file-check" | "calendar" | "clock"
  | "check" | "x" | "alert" | "info"
  | "chevron-right" | "chevron-left" | "chevron-down" | "chevron-up"
  | "arrow-right" | "arrow-left"
  | "plus" | "search" | "settings" | "user" | "users"
  | "sparkles" | "zap" | "activity"
  | "dollar" | "tag" | "trending-up"
  | "building" | "layers" | "grid"
  | "shield" | "list" | "external" | "circle"
  | "bar-chart" | "pie-chart";

const PATHS: Record<IconName, React.ReactNode> = {
  "inbox":         <><polyline points="22 12 16 12 14 15 10 15 8 12 2 12"/><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/></>,
  "mail":          <><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></>,
  "mail-in":       <><path d="M22 13V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h9"/><polyline points="22,6 12,13 2,6"/><polyline points="16 19 19 22 22 19"/><line x1="19" y1="14" x2="19" y2="22"/></>,
  "mail-out":      <><path d="M22 13V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h9"/><polyline points="22,6 12,13 2,6"/><polyline points="22 19 19 22 16 19"/><line x1="19" y1="14" x2="19" y2="22"/></>,
  ...
  "sparkles":      <><path d="M12 3l1.9 5.7L20 11l-6.1 2.3L12 19l-1.9-5.7L4 11l6.1-2.3z"/></>,
...
export function Icon({ name, size = 14, strokeWidth = 1.75, className, style }: Props) {
  return (
    <svg
      width={size}
      height={size}
